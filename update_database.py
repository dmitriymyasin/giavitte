...
def update_database():
    with temp_app.app_context():
        ...
        from models import User, Course, Application, Review, ApplicationStatusHistory
        ...
        print("1. Администратор: Admin / KorokNET")
        print("2. Пользователь 1: user1 / password123")
        print("3. Пользователь 2: user2 / password456")
